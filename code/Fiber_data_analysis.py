...
data_frame = pd.read_csv(tsv_file, sep='\t', header = None, skiprows = 28, nrows = 200)
...
kp.fit(temp_data)
data_O = pykoop.extract_initial_conditions(temp_data, min_samples = 200)
data_predict = kp.predict_trajectory(data_O, relift_state=True)
